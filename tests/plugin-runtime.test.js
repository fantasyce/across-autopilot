...
test("cli loop validation exposes built-in LoopSpec", async () => {
  ...
  assert.deepEqual(builtInIds.sort(), ["aaa-autonomous-self-iteration", "aaa-platform-self-repair", "aaa-release-readiness-gate", "aaa-research-driven-self-iteration", "aaa-self-iteration-product", "daily-news-brief", "external-skills-radar", "github-plugin-radar", "plugin-compatibility-lab-v2", "repo-push-gate", "repo-quality-copilot"]);
